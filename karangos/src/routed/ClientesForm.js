...
export default function ClientesForm() {
    ...
    function validate(data) {
        ...
        // Validação dos campos nome, cpf, rg, logradouro, número do imóvel, 
        // bairro, município, uf, telefone e e-mail
        ...
        if (data.rg.trim() === '' || data.rg.includes('_')) {
            errorTemp.rg = 'O RG deve ser preenchido corre,tamente.'
            isValid = false
        }
    ...
    function handleSubmit(event) {
        ...
        // Salva os dados se eles forem válidos
